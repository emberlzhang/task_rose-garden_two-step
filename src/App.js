...
const App = () => {
  ...
  const [currentFlowerRegions, setCurrentFlowerRegions] = useState(
    practiceFlowerRegions
  );
  ...
  const [yellowOccupiedPositions, setYellowOccupiedPositions] = useState(
    new Set()
  );
      ...
      <Card className="mx-auto" style={{ maxWidth: "600px" }}>
        <Card.Body>
          <Card.Title className="text-center mb-4">
            Welcome to the Rose Garden Game
          </Card.Title>
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Control
                ...
                placeholder="Enter Subject ID or Prolific ID"
              />
            </Form.Group>
    ...
    <Container className="mt-5">
      <Card className="mx-auto" style={{ maxWidth: "800px" }}>
        <Card.Body>
          ...
          <Card.Text>
            Welcome to the Rose Garden Game! Your goal is to grow a beautiful
            rose garden by making strategic decisions at each stage.
          </Card.Text>
          <Card.Text>Here's how to play:</Card.Text>
          <ul className="list-group list-group-flush mb-4">
            <li className="list-group-item">
              In Stage 1, choose between two stores to visit.
            </li>
            <li className="list-group-item">
              In Stage 2, choose between two gardeners to talk to.
            </li>
            <li className="list-group-item">
              You will receive a rose, which will be added to your garden plot.
            </li>
            <li className="list-group-item">
              Roses can be either yellow or red.
            </li>
            <li className="list-group-item">
              Different gardeners have different color roses!
            </li>
            <li className="list-group-item">
              You'll start with 10 practice rounds to get familiar with the
              game.
            </li>
            <li className="list-group-item">
              After the practice, the real game will have 150 rounds.
            </li>
          </ul>
          <div className="text-center">
    ...
    <Container className="mt-5">
      <Card className="mx-auto text-center" style={{ maxWidth: "600px" }}>
        <Card.Body>
          ...
          <Card.Text>
            Great job! You've completed the practice rounds.
          </Card.Text>
          <Card.Text>
            Now you're ready to start the real game, which will have 150 rounds.
          </Card.Text>
  ...
  const handleKeyPress = (event) => {
    ...
    if (event.key === "ArrowLeft" || event.key === "ArrowRight") {
      if (!stage1ChoiceRef.current && stage === "stage1") {
        ...
        const gardener =
          event.key === "ArrowLeft" ? "Gardener 1" : "Gardener 2";
      ...
      <Container className="mt-5">
        <Card className="mx-auto text-center" style={{ maxWidth: "800px" }}>
          <Card.Body>
            ...
            <Card.Text>
              Press Left Arrow for Left Store, Right Arrow for Right Store
            </Card.Text>
            <div className="d-flex justify-content-center align-items-center gap-4 mb-4">
              <img
                ...
                className={`store-image ${
                  selectedStore === "Store 1" ? "selected" : ""
                }`}
              />
              <img
                ...
                className={`store-image ${
                  selectedStore === "Store 2" ? "selected" : ""
                }`}
              />
            </div>
            <Card.Text>
              {isPractice ? "Practice " : ""}Round: {roundCount} /{" "}
              {isPractice ? PRACTICE_ROUNDS : MAX_ROUNDS}
            </Card.Text>
          </Card.Body>
        </Card>
      </Container>
  ...
  const handleStage1Choice = (store, keypress) => {
    ...
    if (store === "Store 1") {
      gardenerPair =
        randomValue < 0.8 ? GARDENER_PAIRS.pair1 : GARDENER_PAIRS.pair2;
    } else {
      gardenerPair =
        randomValue < 0.8 ? GARDENER_PAIRS.pair2 : GARDENER_PAIRS.pair1;
    }
    ...
    <Container className="mt-5">
      <Card className="mx-auto text-center" style={{ maxWidth: "800px" }}>
        <Card.Body>
          ...
          <Card.Text>
            Press Left Arrow for Left Gardener, Right Arrow for Right Gardener
          </Card.Text>
          <div className="d-flex justify-content-center align-items-center gap-4 mb-4">
            <img
              ...
              className={`gardener-image ${
                selectedGardener === "Gardener 1" ? "selected" : ""
              }`}
            />
            <img
              ...
              alt="Gardener B"
              className={`gardener-image ${
                selectedGardener === "Gardener 2" ? "selected" : ""
              }`}
            />
          </div>
          <Card.Text>
  ...
  const handleStage2Choice = (gardener, keypress) => {
    ...
    const gardenerId = currentGardenerPair[gardener === "Gardener 1" ? 0 : 1]
      .split("/")
      .pop()
      .split(".")[0];
    ...
    const roseColor =
      Math.random() < gardenerProbabilities.red ? "red" : "yellow";
    ...
    setTimeout(() => {
      // Start reward phase after a delay
  ...
  const drawRose = (ctx, rose) => {
    ...
    const img = new Image();
    img.src =
      rose.roseColor === "yellow" ? "/yellow_rose.png" : "/red_rose.png";
    img.onload = () => {
      ...
      <Container className="mt-4">
        <Card className="mx-auto" style={{ maxWidth: "800px" }}>
          <Card.Body className="text-center">
            {stage !== "gameOver" && (
              <Card.Title>Your rose garden is growing...</Card.Title>
            )}
  ...
  return (
    <Container
      fluid
      className="p-3"
      style={{ backgroundColor: "mediumseagreen", minHeight: "100vh" }}
    >
