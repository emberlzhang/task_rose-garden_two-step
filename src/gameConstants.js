...
export const MAX_ROUNDS = 30; // need to set to 150 for real game

// Intervals
export const REWARD_INTERVAL = 1000;
export const INTERTRIAL_INTERVAL_1 = [400, 600, 800][Math.floor(Math.random() * 3)];
export const INTERTRIAL_INTERVAL_2 = [400, 600, 800][Math.floor(Math.random() * 3)];
